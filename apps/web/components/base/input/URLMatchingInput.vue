<template>
  <div class="flex flex-col w-full">
    ...
    >
      ...
      <!-- indicator -->
      <i
        class="fi fi-sr-check text-emerald-500 bg-emerald-100 h-6 w-6 rounded-full text-sm"
      ></i>
    </div>
...
interface URLMatchingInputProps extends BaseInputProps {}
const { name, modelValue } = defineProps<URLMatchingInputProps>()
